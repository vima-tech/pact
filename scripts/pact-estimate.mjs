...
//
//   用法: node pact-estimate.mjs [PACT.md] [--rate=.pact/rate-card.json] [--out=.pact/estimate-calc.md]
...
// ── 参数 ────────────────────────────────────────────────────────────────────
let FILE = 'PACT.md', RATE = '.pact/rate-card.json', OUT = '.pact/estimate-calc.md'
...
const md = [
  ...
  `> 对外承诺请用 \`.pact/estimate.md\` 的完整格式（含前提、假设、阻塞源、停工线）。`, '',
  `## 分层`, '',
