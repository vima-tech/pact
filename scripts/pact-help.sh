...
echo "  bash $SKILL_DIR/scripts/pact-book.sh --check"
echo ""
echo "工期估算（S7 · 要报价/排期时）:"
echo "  bash $SKILL_DIR/scripts/pact-estimate.sh PACT.md          # 可持续卡"
echo "  bash $SKILL_DIR/scripts/pact-estimate.sh PACT.md --card=peak  # 峰值卡，禁止承诺"
