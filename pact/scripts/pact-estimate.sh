...
#
#   用法: bash pact-estimate.sh [PACT.md] [--card=peak|sustain] [--rate=<物料目录>/rate-card.json]
#                               [--persons=1,2,3,4] [--out=<物料目录>/estimate-calc.md] [--json] [--quiet]
#
...
# 直接给了 .md 文件就原样传递；否则按物料目录解析（未给时自动扫描 ./.pact/*/PACT.md）
